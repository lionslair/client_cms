...
//arrowimages: {down:['downarrowclass', 'images/spacer.gif', 10], right:['rightarrowclass', 'images/right.gif']}, change by nav
  arrowimages: {down: ['downarrowclass', '/images/down.png', 25], right: ['rightarrowclass', '/images/right.gif']},
...
ddsmoothmenu.init({
  mainmenuid: 'second-menu', //menu DIV id
...
(function($) {
  $(document).ready(function() {
    ...
    $('.ddsmoothmenu > ul.active').show();
    $('#first-menu a').hover(function() {
      // Change main active menu
      $('#first-menu a').removeClass('active');
      $(this).addClass('active');
      // Show matched second menu level
      $('.ddsmoothmenu > ul').hide();
      $('#' + $(this).attr('rel')).show();
      return false;
    });
